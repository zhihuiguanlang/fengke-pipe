<template>
  <div class="survey">
    <div class="handle">
      <v-btn class="mr-3" outlined color="light-green" @click="addSurvey">
        <v-icon left v-text="'mdi-plus'" />
        添加勘察档案
      </v-btn>
      <v-btn class="mr-3" outlined color="cyan" @click="amendSurvey">
    ...
    <v-dialog v-model="dialog" light persistent max-width="600px">
      <v-card>
        <v-card-title>
          <span class="headline">Survey Profile</span>
        </v-card-title>
        <v-card-text>
          <v-container>
